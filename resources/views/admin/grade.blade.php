        ...
        <div class="card">
            <div class="card-body">
                <div class="mb-2 text-end">
                    <a href="{{ asset('admin/grade/create') }}" class="btn btn-primary px-4">
                ...
                columnDefs: [
                    {
                        ...
                        render: function(data, type, full, meta) {
                            return `<a href="{{ asset('admin/grade/edit/') }}/`+data.id+`" \
                                                title="edit" class="btn"\
                                                data-id="`+data.id+`">\
                                                <i class="ti ti-pencil text-success fs-4 me-2"></i></a>\
                                                \
                                <form id="form_`+data.id+`" action="{{asset('admin/grade/destroy') }}/`+data.id+`"\
